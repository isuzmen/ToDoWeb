...
const closeEventBox = document.getElementById('close-event-box');
...
document.getElementById('event-form').onsubmit = async (e) => {
  ...
  try {
      const response = await fetch('https://localhost:44334/api/Note/create', {
          method: 'POST',
          headers: {
      ...
      if (response.ok) {
          ...
          alert(`Note creation failed: ${responseText}`);
      }
  } catch (error) {
